...
- Mocked investment (3 assets, deterministic price curve — no live market API), unlocked by a turn-1 开户 story beat (v1.3); the invest beat is ONE panel showing all 3 assets at once, each row carrying a K-line history chart + per-turn 热点新闻 + a cognition-gated 建议 tag (适宜/谨慎/不适宜/看不懂 — the lower your cognition, the less trustworthy the advice, v1.5)
