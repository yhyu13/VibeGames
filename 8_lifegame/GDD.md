...
- **人生目标 (v2.5)**: the opening is a 2-step cinematic — 出身故事 (小镇做题家的绿皮火车 / 世家不想被看见的车牌) then 人生目标 — establishing BOTH goals at the start: a wealth goal (小镇 ¥150,000 / 世家 ¥400,000, tracked as a HUD progress chip and a summary 达成/进行中 verdict) and a love goal (stage-derived: `close` or the winter reunion). Goals are read-only presentation state.
