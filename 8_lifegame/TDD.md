# TDD — Stock God Simulator: Intro Scene (current contract v2.8)
...
**Origin-aware event pools (v2.5)**: `specialEventsFor(origin)` — 小镇 keeps the 51-event 小镇 life pool; 金融世家 runs swap the hometown/small-money/big-surprise slices for 16 世家 events (家族季度汇报会、父亲的电话、母亲的电话、家族信托分红、私人银行经理、董事会交锋、名媛圈、"不过是投了个好胎"、海归交换生夜聊、慈善晚宴签单、父亲住院、第一笔自己挣的钱、继承人之争短信、私募酒会真话、校门口的车、老宅照片), sharing the market shocks, friends, and health slices. Both pools keep `assetShock`/`choices`; trigger probability stays 0.55.
