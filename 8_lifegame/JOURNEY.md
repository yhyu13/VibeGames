...
- **穿越AI（Ch10，待办）** —— 用户提的「知道未来的 AI 指导做题家投资」。朴素版会拆掉「认知觉醒靠挣 + 信息差承重墙」；能救活的版本 = 穿越AI × 接住质量（宏观未来提示，认知不够就接不住，复用 Ch07 机制）。下一次 spec + test（Ch09 era）。
- **付费贵人 / 贵人流转 / Ch09 金牌策略** —— 出范围，留 M2+（付费贵人 + 金牌策略缺 Token 系统，贵人流转缺多时代；Ch09 era）。
- **smoke-seeds / seeds10 / marathon 在本环境 headless 超时** —— rAF 降频导致多种子/长回放太慢，非代码问题（单种子 showcase/dynasty 均跑完 0 error）；需有头环境重跑（Ch07/Ch09 era）。
