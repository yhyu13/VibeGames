...
// but wiring one is out of scope for a 4-turn intro scene).
export const ASSETS: Asset[] = [
  { id: 'a_index', label: 'A股指数', icon: '📈', ticks: [2, -3, 5, 1, 4, -2, 3, 6] },
  { id: 'hk_index', label: '港股指数', icon: '🌊', ticks: [-1, 4, 2, -4, 6, 1, -2, 5] },
  { id: 'btc', label: 'BTC', icon: '🪙', ticks: [8, -12, 15, -6, 20, -8, 10, 25] },
]
