class clazz.wp_sbeam extends clazz.weapon_phix
{
   var seths;
   var xp = 0;
   var xpmax = 0;
   ...
   function doit()
   {
      if(this._parent._parent[this._parent._name + this._name + "_" + this.przdi()] == undefined)
      {
         ...
         if(this.t <= 0 && this._parent.lockon && this._zt == "nor")
         {
            ...
            this._parent._parent.attachMovie("dd_sbeam",this._parent._name + this._name + "_" + this.zdi,this._parent._parent.getNextHighestDepth(),{_sX:_loc3_.x,_sY:_loc3_.y,_sZ:_loc3_.z,_sW:this._parent.shotw,_sH:this._parent.shoth,_siz:this.fsiz,_alpha:0});
