class clazz.wp_zd extends clazz.weapon_phix
{
   var seths;
   var fsn = 0;
   var ln = 0;
   ...
   function doit()
   {
      ...
      if((this.t <= 0 || this.t == this.ct - 5 * this.fsn) && this.cn > 0 && this._zt == "nor")
      {
         ...
         this._parent._parent.attachMovie("dd_zd",this._parent._name + this._name + "_" + this.zdi,this._parent._parent.getNextHighestDepth(),{_sX:_loc3_.x,_sY:_loc3_.y,_sZ:_loc3_.z,_sW:_loc6_,_sH:_loc7_,htime:_loc5_,_slo:this.fsiz * 3,_siz:this.fsiz,_sizz:0.3});
