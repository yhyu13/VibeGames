class clazz.sline_phix
{
   ...
   function getp()
   {
      ...
      if(this._LN != null)
      {
         if(this._par.linelist[this._LN] != null)
         {
            this._sX2 = this._par.linelist[this._LN]._sX;
            this._sY2 = this._par.linelist[this._LN]._sY;
            this._sZ2 = this._par.linelist[this._LN]._sZ;
            this._ucX = this._par.linelist[this._LN]._cX;
            this._ucY = this._par.linelist[this._LN]._cY;
            this._ucZ = this._par.linelist[this._LN]._cZ;
         }
         else
         {
            this.getuXYZ();
      ...
      if(_global.Cmr.isShow >= 0)
      {
         ...
         if(this.p2y != null && this.p1y != null && this.p2x != null && this.p1x != null)
         {
            if(this._siz > 0)
            {
               ...
               var _loc6_ = 0.5 * this.p1c * this._siz * this._siz1;
               var _loc9_ = 0.5 * this.p2c * this._siz * this._siz2;
               ...
               if(_loc6_ - _loc9_ > _loc14_)
               {
                  ...
                  _loc8_ = _loc6_ * Math.cos(_loc3_ + 3.141592653589793);
                  _loc7_ = _loc6_ * Math.sin(_loc3_ + 3.141592653589793);
                  _loc11_ = _loc5_;
                  _loc10_ = _loc4_;
                  _loc13_ = - _loc8_;
                  _loc12_ = - _loc7_;
               }
               else if(_loc9_ - _loc6_ > _loc14_)
               {
                  this.p1x = 0.99 * this.p2x + 0.01 * this.p1x;
                  this.p1y = 0.99 * this.p2y + 0.01 * this.p1y;
                  _loc5_ = _loc9_ * Math.cos(_loc3_ + 1.5707963267948966);
                  _loc4_ = _loc9_ * Math.sin(_loc3_ + 1.5707963267948966);
                  _loc8_ = _loc9_ * Math.cos(_loc3_ + 3.141592653589793);
                  _loc7_ = _loc9_ * Math.sin(_loc3_ + 3.141592653589793);
                  _loc11_ = _loc5_;
                  _loc10_ = _loc4_;
                  _loc13_ = - _loc8_;
                  _loc12_ = - _loc7_;
               ...
               else
               {
                  ...
                  _loc8_ = _loc6_ * Math.cos(_loc3_ + 3.141592653589793);
                  _loc7_ = _loc6_ * Math.sin(_loc3_ + 3.141592653589793);
                  _loc11_ = _loc5_ * this._siz2 * this.p2c / (this.p1c * this._siz1);
                  _loc10_ = _loc4_ * this._siz2 * this.p2c / (this.p1c * this._siz1);
                  _loc13_ = (- _loc8_) * this._siz2 * this.p2c / (this.p1c * this._siz1);
                  _loc12_ = (- _loc7_) * this._siz2 * this.p2c / (this.p1c * this._siz1);
               }
               _loc8_ = this.p1x + _loc8_;
               _loc7_ = this.p1y + _loc7_;
               ...
               _loc26_ = _loc8_ - 0.8 * _loc5_;
               _loc25_ = _loc7_ - 0.8 * _loc4_;
               _loc21_ = _loc8_ + 0.8 * _loc5_;
               _loc16_ = _loc7_ + 0.8 * _loc4_;
               ...
               this._par.beginFill(this._colo,this._alpha);
               this._par.lineStyle();
               this._par.moveTo(_loc11_,_loc10_);
               this._par.curveTo(_loc23_,_loc19_,_loc13_,_loc12_);
               this._par.curveTo(_loc24_,_loc20_,_loc22_,_loc17_);
               this._par.lineTo(_loc18_,_loc15_);
               this._par.curveTo(_loc26_,_loc25_,_loc8_,_loc7_);
               this._par.curveTo(_loc21_,_loc16_,_loc5_,_loc4_);
               this._par.endFill();
               if(this._par._glow > 0)
               {
                  this.p1x = _loc29_;
                  this.p2x = _loc28_;
                  this.p1y = _loc27_;
                  this.p2y = _loc30_;
                  _loc6_ = 0.5 * this.p1c * (this._siz * this._siz1 + this._par._glow);
                  _loc9_ = 0.5 * this.p2c * (this._siz * this._siz2 + this._par._glow);
                  if(_loc6_ - _loc9_ > _loc14_)
                  {
                     this.p2x = 0.99 * this.p1x + 0.01 * this.p2x;
                     this.p2y = 0.99 * this.p1y + 0.01 * this.p2y;
                  ...
                  else
                  {
                     ...
                     _loc8_ = _loc6_ * Math.cos(_loc3_ + 3.141592653589793);
                     _loc7_ = _loc6_ * Math.sin(_loc3_ + 3.141592653589793);
                     _loc11_ = _loc9_ * Math.cos(_loc3_ + 1.5707963267948966);
                     _loc10_ = _loc9_ * Math.sin(_loc3_ + 1.5707963267948966);
                     _loc13_ = (- _loc9_) * Math.cos(_loc3_ + 3.141592653589793);
                     _loc12_ = (- _loc9_) * Math.sin(_loc3_ + 3.141592653589793);
                  }
                  _loc8_ = this.p1x + _loc8_;
                  _loc7_ = this.p1y + _loc7_;
                  _loc13_ = this.p2x + _loc13_;
                  ...
                  _loc11_ = this.p2x + _loc11_;
                  _loc10_ = this.p2y + _loc10_;
                  this._par.beginFill(this._colo,this._par.glow_alpha);
                  this._par.lineStyle();
                  this._par.moveTo(_loc11_,_loc10_);
                  this._par.curveTo(_loc23_,_loc19_,_loc13_,_loc12_);
                  this._par.curveTo(_loc24_,_loc20_,_loc22_,_loc17_);
               ...
               if(this._glow > 0)
               {
                  ...
                  this.p1y = _loc27_;
                  this.p2y = _loc30_;
                  _loc6_ = 0.5 * this.p1c * (this._siz * this._siz1 + this._glow);
                  _loc9_ = 0.5 * this.p2c * (this._siz * this._siz2 + this._glow);
                  if(_loc6_ - _loc9_ > _loc14_)
                  {
                     this.p2x = 0.99 * this.p1x + 0.01 * this.p2x;
                     this.p2y = 0.99 * this.p1y + 0.01 * this.p2y;
                  ...
                  _loc11_ = this.p2x + _loc11_;
                  _loc10_ = this.p2y + _loc10_;
                  this._par.beginFill(this._colo,this.glow_alpha);
                  this._par.lineStyle();
                  this._par.moveTo(_loc11_,_loc10_);
                  this._par.curveTo(_loc23_,_loc19_,_loc13_,_loc12_);
                  this._par.curveTo(_loc24_,_loc20_,_loc22_,_loc17_);
            ...
            {
               this._par.beginFill(this._colo,this.glow_alpha);
               this._par.lineStyle(-1 * this._siz,this._colo,this._alpha);
               this._par.moveTo(this.p1x,this.p1y);
               this._par.lineTo(this.p2x,this.p2y);
               this._par.endFill();
            }
         }
      }
   ...
   function remove()
   {
      this._par.linelist[this._N] = null;
   }
