class clazz.wp_beam extends clazz.weapon_phix
{
   function wp_beam()
   {
      super();
   ...
   function doit()
   {
      ...
      if(this.t <= 0 && this._zt == "nor")
      {
         ...
         this._parent._parent.attachMovie("dd_beam",this._parent._name + this._name + "_" + this.zdi,this._parent._parent.getNextHighestDepth(),{_sX:_loc4_.x,_sY:_loc4_.y,_sZ:_loc4_.z,_sW:this._parent.shotw,_sH:this._parent.shoth,_slo:random(20) + 10,_siz:this.fsiz});
         ...
         this._parent._parent[this._parent._name + this._name + "_" + this.zdi].maxlong = _loc3_ * this.ddspeedlv;
         this.zdi = this.nxzdi();
