class clazz.wp_fyX extends clazz.weapon_phix
{
   var seths;
   var fireauto;
   var ln = 0;
   ...
   function doit()
   {
      if(this.t <= 0 && this.cn > 0 && this._parent.lockon && this._zt == "nor")
      {
         ...
         this._parent._parent.attachMovie("dd_fyX",this._parent._name + this._name + "_" + this.zdi,this._parent._parent.getNextHighestDepth(),{_sX:_loc3_.x,_sY:_loc3_.y,_sZ:_loc3_.z,_sW:this._parent.shotw + (random(25) - 12) * 3.141592653589793 / 48,_sH:this._parent.shoth + (random(25) - 12) * 3.141592653589793 / 48,_alpha:0});
