class clazz.wp_fy extends clazz.weapon_phix
{
   var seths;
   var fynA;
   var fireauto;
      ...
      this.seths = function()
      {
         ...
         while(_loc2_ <= this.maxcn)
         {
            if(this._parent._parent[this._parent._name + this._name + "_" + _loc2_] != undefined)
            {
               ...
               if(this._parent._parent[this._parent._name + this._name + "_" + _loc2_].holdmst)
               {
                  _loc3_ = _loc3_ + 1;
               }
            }
         ...
         if(this.fsiz > 1)
         {
            if(this._parent._SP >= 10000 && _loc3_ >= 5 && this._parent.defon == 30 && this._parent._parent[this._parent._name + "_fif"] == undefined)
            {
               this._parent._parent.attachMovie("ob_fif",this._parent._name + "_fif",this._parent._parent.getNextHighestDepth(),{_sX:this._parent._sX,_sY:this._parent._sY,_sZ:this._parent._sZ,_sW:this._parent._sW,_sH:this._parent._sH,_sR:this._parent._sR});
               this._parent._parent[this._parent._name + "_fif"].mst = this._parent._name;
            }
            else if((_loc3_ < 5 || this._parent.GDon || this._parent.hypt != 0 || this._parent._SP < 10000) && this._parent._parent[this._parent._name + "_fif"] != undefined)
            {
               this._parent._parent[this._parent._name + "_fif"].removeMovieClip();
            }
         }
         ...
         if(this.t <= 0 && this._parent.lockon)
         {
            ...
            while(true)
            {
               if(this.qn > 0)
               {
                  ...
                  this._parent._parent.attachMovie("dd_fy",this._parent._name + this._name + "_" + _loc3_,this._parent._parent.getNextHighestDepth(),{_sX:_loc5_.x,_sY:_loc5_.y,_sZ:_loc5_.z,_sW:this._parent.shotw + (random(25) + 36) * 3.141592653589793 / 48,_sH:this._parent.shoth + (random(25) - 12) * 3.141592653589793 / 48,_alpha:0});
                  ...
                  this._parent._parent[this._parent._name + this._name + "_" + _loc3_].fsiz = this.fsiz;
                  if(this.fy < 0)
                  {
   ...
   function callit(tgt)
   {
      if(this.t <= 0 && this._zt == "nor" && this.cn > 0)
      {
         ...
         var _loc5_ = new Object();
         _loc5_ = _global.moveobj(this._parent.objz,this.fx,this.fy,this.fz);
         this._parent._parent.attachMovie("dd_fy",this._parent._name + this._name + "_" + _loc4_,this._parent._parent.getNextHighestDepth(),{_sX:_loc5_.x,_sY:_loc5_.y,_sZ:_loc5_.z,_sW:this._parent.shotw + (random(25) + 36) * 3.141592653589793 / 48,_sH:this._parent.shoth + (random(25) - 12) * 3.141592653589793 / 48,_alpha:0});
   ...
   function showit()
   {
      ...
      while(_loc3_ <= this._parent.linelist.length - 1)
      {
         ...
         {
            if(this._parent[this._parent.linelist[_loc3_].nam].flag == "fy" + _loc2_)
            {
