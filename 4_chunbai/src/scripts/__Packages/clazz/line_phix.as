class clazz.line_phix extends MovieClip
{
   var _sX = 0;
   var _sY = 0;
   var _sZ = 0;
      ...
      if(_global.Cmr.isShow >= 0)
      {
         ...
         if(this.p2y != null && this.p1y != null && this.p2x != null && this.p1x != null)
         {
            if(this._siz > 0)
            {
               ...
               this.moveTo(_loc11_,_loc10_);
               this.curveTo(_loc23_,_loc19_,_loc13_,_loc12_);
               this.curveTo(_loc24_,_loc20_,_loc22_,_loc17_);
               this.lineTo(_loc18_,_loc15_);
               this.curveTo(_loc26_,_loc25_,_loc9_,_loc8_);
               this.curveTo(_loc21_,_loc16_,_loc5_,_loc4_);
               this.endFill();
               if(this._glow > 0)
               {
                  this.p1x = _loc29_;
                  ...
                  this.p1y = _loc27_;
                  this.p2y = _loc30_;
                  _loc7_ = 0.5 * this.p1c * (this._siz * this._siz1 + this._glow);
                  _loc6_ = 0.5 * this.p2c * (this._siz * this._siz2 + this._glow);
                  if(_loc7_ - _loc6_ > _loc14_)
                  {
                     this.p2x = 0.99 * this.p1x + 0.01 * this.p2x;
                     this.p2y = 0.99 * this.p1y + 0.01 * this.p2y;
                  ...
                  _loc11_ = this.p2x + _loc11_;
                  _loc10_ = this.p2y + _loc10_;
                  this.beginFill(this._colo,this.glow_alpha);
                  this._parent.lineStyle();
                  this.moveTo(_loc11_,_loc10_);
                  this.curveTo(_loc23_,_loc19_,_loc13_,_loc12_);
                  this.curveTo(_loc24_,_loc20_,_loc22_,_loc17_);
            ...
            {
               this.beginFill(this._colo,this.glow_alpha);
               this.lineStyle(-1 * this._siz,this._colo);
               this.moveTo(this.p1x,this.p1y);
               this.lineTo(this.p2x,this.p2y);
               this.endFill();
            }
         }
      }
   ...
   function hitobj(obj, r)
   {
      ...
      {
         var _loc4_ = _global.dist_3d(this._sX,this._sY,this._sZ,obj._sX,obj._sY,obj._sZ);
         ...
         if(this._slo > 0 && _loc4_ <= this._slo)
         {
            _loc3_ = new Object();
            var _loc10_ = Math.cos(this._sH);
            var _loc7_ = Math.sin(this._sH);
            _loc3_._sZ = _loc4_ * _loc7_;
            var _loc8_ = _loc4_ * _loc10_;
            _loc3_._sX = _loc8_ * Math.sin(this._sW);
            _loc3_._sY = _loc8_ * Math.cos(this._sW);
            _loc3_._sZ += this._sZ;
            _loc3_._sX += this._sX;
            _loc3_._sY += this._sY;
            var _loc9_ = _global.dist_3d(_loc3_._sX,_loc3_._sY,_loc3_._sZ,obj._sX,obj._sY,obj._sZ);
            if(_loc9_ <= r)
            {
               _loc4_ += _loc9_ - r;
               _loc3_._sZ = _loc4_ * _loc7_;
         ...
         {
            _loc3_ = new Object();
            _loc10_ = Math.cos(this._sH);
            _loc7_ = Math.sin(this._sH);
            _loc3_._sZ = (- _loc4_) * _loc7_;
            _loc8_ = (- _loc4_) * _loc10_;
            _loc3_._sX = _loc8_ * Math.sin(this._sW);
            _loc3_._sY = _loc8_ * Math.cos(this._sW);
            ...
            _loc3_._sX += this._sX;
            _loc3_._sY += this._sY;
            _loc9_ = _global.dist_3d(_loc3_._sX,_loc3_._sY,_loc3_._sZ,obj._sX,obj._sY,obj._sZ);
            if(_loc9_ <= r)
            {
               _loc4_ += _loc9_ - r;
               _loc3_._sZ = _loc4_ * _loc7_;
