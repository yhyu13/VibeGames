class clazz.wp_axe extends clazz.weapon_phix
{
   var seths;
   var wpi;
   function wp_axe()
   ...
   function showit()
   {
      ...
      this._parent._parent.attachMovie("ob_axe",this._parent._name + this._name + "_ob",this._parent._parent.getNextHighestDepth(),{_sX:_loc3_.x,_sY:_loc3_.y,_sZ:_loc3_.z,_sW:this._parent.shotw,_sH:this._parent.shoth,_siz:this.fsiz,_slo:10 * this.fsiz,_alpha:0});
      ...
      if(this.fn == 2)
      {
         this._parent._parent[this._parent._name + this._name + "_ob"].wptx = "tx_axe2";
      }
      else
      {
         this._parent._parent[this._parent._name + this._name + "_ob"].wptx = "tx_axe";
      }
   }
}
