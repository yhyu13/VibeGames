class clazz.wp_Ccannon extends clazz.weapon_phix
{
   var seths;
   var wpi;
   var ln = 0;
   function wp_Ccannon()
   {
      ...
      this.seths = function()
      {
         ...
         {
            if(this._parent.lockon && (this.t > 0 || this._zt == "nor") && this._parent.dst > 5000)
            {
               if(this._parent.scmrfg < 30)
               {
   ...
   function doit()
   {
      if(this.t <= 0 && this.cn > 0 && this._parent.lockon && this._zt == "nor")
      {
         ...
         this._parent._parent.attachMovie("dd_Ccannon",this._parent._name + this._name + "_" + this.zdi,this._parent._parent.getNextHighestDepth(),{_sX:_loc3_.x,_sY:_loc3_.y,_sZ:_loc3_.z,_sW:this._parent.shotw,_sH:this._parent.shoth,_slo:this.ddspeedlv,_siz:0.01,_sizz:100 * this.fsiz});
         ...
         if(this.cn > 0 && this.fn > 1)
         {
            ...
            this._parent._parent[this._parent._name + this._name + "_" + this.zdi].dam = this.damlv;
            this._parent._parent[this._parent._name + this._name + "_" + this.zdi].maxforce = this.maxforce;
            this._parent._parent[this._parent._name + this._name + "_" + this.zdi].speed = this.ddspeedlv + 2;
            this.zdi = this.nxzdi();
            this._parent.atton = 5;
            this.cn -= 1;
         }
