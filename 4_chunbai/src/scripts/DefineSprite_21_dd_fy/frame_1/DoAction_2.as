      ...
      else if(this.actmode == "hold" || this.actmode == "qishe")
      {
         if(this._parent[this.mst] != undefined)
         {
            ...
            else
            {
               ...
               {
                  this.holdmst = true;
                  if(this._parent[this.mst + "_fif"] == undefined)
                  {
                     if(t % 2 == 0)
                     {
               ...
               if(dst < 50)
               {
                  ...
                  else if(this.actmode == "qishe" && t >= axt + 10)
                  {
                     ...
                     if(tdst < 4000 && this._parent[this.mst].covon)
                     {
                        ...
                        if(this._parent[this.mst].hypt > 0)
                        {
                           this.qishelock = true;
                        }
                        else
      ...
      else if(t == axt + 10)
      {
         if(fsiz < 10)
         {
            if(this._parent[this.qstgt] != undefined && this._parent[this.mst]._zt == "nor")
            {
               ...
               {
                  _loc6_ = this._parent[this.qstgt]._sX - this._sX + random(51) - 25;
                  _loc5_ = this._parent[this.qstgt]._sY - this._sY + random(51) - 25;
                  _loc8_ = this._parent[this.qstgt]._sZ - this._sZ + random(51) - 25;
               }
               dst = dist_3d(0,0,0,_loc6_,_loc5_,_loc8_);
               var _loc9_ = (dst + random(40) * 10) / 200;
         ...
         else if(this._parent[this.qstgt] != undefined && this._parent[this.mst]._zt == "nor")
         {
            _root.jiemiam.hkxsq[this._name].jiantou.gotoAndStop(1);
            if(this.qishelock)
            {
               _loc6_ = this._parent[this.qstgt]._sX - this._sX;
               _loc5_ = this._parent[this.qstgt]._sY - this._sY;
               _loc8_ = this._parent[this.qstgt]._sZ - this._sZ;
            }
            else
            {
            ...
            dst = dist_3d(0,0,0,_loc6_,_loc5_,_loc8_);
            _loc9_ = (dst + random(40) * 20) / 200;
            _loc6_ += this._parent[this.qstgt].v._sX * _loc9_;
            _loc5_ += this._parent[this.qstgt].v._sY * _loc9_;
            _loc8_ += this._parent[this.qstgt].v._sZ * _loc9_;
            _loc10_ = Math.atan2(_loc6_,_loc5_);
            _loc11_ = Math.atan2(_loc8_,distance(0,0,_loc6_,_loc5_));
            this._sH = _loc11_;
            this._sW = _loc10_;
