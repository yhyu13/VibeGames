   ...
   if(!stopAll)
   {
      ...
      else if(t < 30)
      {
         ...
         if(_parent[mst] != undefined)
         {
            ...
            {
               var _loc17_ = _parent[tgt]._sX - this._parent[mst]._sX;
               var _loc16_ = _parent[tgt]._sY - this._parent[mst]._sY;
               var _loc14_ = _parent[tgt]._sZ - this._parent[mst]._sZ;
               var _loc15_ = dist_3d(0,0,0,_loc17_,_loc16_,_loc14_);
               this.dstS = _loc15_;
            }
            var _loc12_ = new Object();
            _loc12_ = rotateobj(this._parent[mst].objz,this.fw,this.fh,this.fr);
            this._sW = _loc12_.w;
            this._sH = _loc12_.h;
            ...
            this._sX = _loc10_.x;
            this._sY = _loc10_.y;
            this._slo += this.speed;
            if(this._slo > this.maxforce)
            {
      ...
      else
      {
         if(_parent[mst] != undefined)
         {
            ...
            if(_parent[tgt] != undefined)
            {
               _loc17_ = _parent[tgt]._sX - this._parent[mst]._sX;
               _loc16_ = _parent[tgt]._sY - this._parent[mst]._sY;
               _loc14_ = _parent[tgt]._sZ - this._parent[mst]._sZ;
               _loc15_ = dist_3d(0,0,0,_loc17_,_loc16_,_loc14_);
               this.dstS = _loc15_;
            }
            this._parent[mst].AMBAC = 5;
            _loc12_ = new Object();
         ...
         if(_parent[tgt] != undefined)
         {
            ...
            mdx = _loc20_ * _loc11_ + _parent[tgt]._sX;
            mdy = _loc19_ * _loc11_ + _parent[tgt]._sY;
            mdz = _loc18_ * _loc11_ + _parent[tgt]._sZ;
         }
         else
         {
            _loc10_ = new Object();
