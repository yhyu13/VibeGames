...
onEnterFrame = function()
{
   if(!stopAll)
   {
      ...
      else
      {
         ...
         var _loc8_ = speed * Math.cos(this._sH);
         this._sX += _loc8_ * Math.sin(this._sW) + this.basex;
         this._sY += _loc8_ * Math.cos(this._sW) + this.basey;
      }
         ...
         if(_loc3_ != null && _loc3_ != undefined)
         {
            ...
            else
            {
               ...
               if(this._parent[tgt].shdon >= 0)
               {
                  ...
                  _loc7_ = _global.sToc(_loc11_,_loc10_,_loc9_,this._parent[tgt].objz._sW,this._parent[tgt].objz._sH,this._parent[tgt].objz._sR);
               }
               else
               {
                  _loc7_.y = 0;
               }
               if(_loc7_.y > 5 && this._parent[tgt].doSHD(this.dam))
               {
                  snd("snd_launch3");
                  this._sX2 = _loc3_._sX;
                  this._sY2 = _loc3_._sY;
