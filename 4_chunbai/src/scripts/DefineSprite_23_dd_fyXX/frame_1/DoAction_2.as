   ...
   if(!stopAll)
   {
      ...
      if(this._parent[this.mst] != undefined)
      {
         ...
         while(_loc4_ <= 9)
         {
            ...
            if(_parent[_name + "wj"].linelist[_loc4_].lv == 9)
            {
               ...
               _loc8_ = moveobj(this._parent[mst].objz,this.fx,this.fy,this.fz);
               _parent[_name + "wj"].linelist[_loc4_]._sX2 = _loc8_.x;
               _parent[_name + "wj"].linelist[_loc4_]._sY2 = _loc8_.y;
               _parent[_name + "wj"].linelist[_loc4_]._sZ2 = _loc8_.z;
            }
            _loc4_ = _loc4_ + 1;
         }
      }
      ...
      if(t == axt + 10)
      {
         if(this._parent[this.tgt] != undefined && this._parent[this.mst]._zt == "nor")
         {
            ...
            snd("gsqs");
            var _loc7_ = 0;
            while(_loc7_ < this.fn)
            {
               if(_loc7_ == 0)
               {
                  this._parent.attachMovie("dd_fygs",_name + _loc7_ + "ddq" + t,this._parent.getNextHighestDepth(),{_sX:this._sX,_sY:this._sY,_sZ:this._sZ,_sW:_sW,_sH:_sH,_slo:random(20) + 10,_siz:1,dam:this.dam});
               }
               else
               {
                  this._parent.attachMovie("dd_fygs",_name + _loc7_ + "ddq" + t,this._parent.getNextHighestDepth(),{_sX:this._sX,_sY:this._sY,_sZ:this._sZ,_sW:_sW + (random(10) - 5) * 0.002 * 3.141592653589793,_sH:_sH + (random(10) - 5) * 0.002 * 3.141592653589793,_slo:random(20) + 10,_siz:1,dam:this.dam});
               }
               this._parent[_name + _loc7_ + "ddq" + t].mst = this.mst;
               this._parent[_name + _loc7_ + "ddq" + t].tgt = this.tgt;
               _loc7_ = _loc7_ + 1;
            }
