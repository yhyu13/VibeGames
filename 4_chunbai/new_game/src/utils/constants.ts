...
export const CAMERA_BRAKE_STIFFNESS = 20;
export const CONTROL_K = 2.5;
export const BRAKE_K = 10;
export const AIR_DRAG = 1.2;
export const BRAKE_PITCH = 0.14;
export const BRAKE_PITCH_RAMP = 0.2;
export const BRAKE_PITCH_EASE = 0.4;
export const IDLE_BOB_AMP = 0.05;
export const IDLE_BOB_SPEED = 1.2;
