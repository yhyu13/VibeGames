...
| ME | YOU |
|---|---|
| 丢来知乎长文「从 PBR 贴图到潜变量 + MLP」+「research and demo」「no question until perfection」 | 对照 SIGGRAPH 2026 课程仓库 / Zeltner 2024 / WebGPU 现状做了 primary-source 笔记（`references/neural-shading/research.md`）。砍掉 CoopVec、MDL、4K latent、页内 100k 训练。冻结 intro：三球 GGX vs `8+6→32→32→3`，端口 5190。 |
