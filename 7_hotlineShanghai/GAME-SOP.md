...
| 敏感度红线 | 敌对 NPC 按职能命名（占领军/伪警/特务/帮派），不写负面族群刻板；每批新文案过 17 号 checklist（[`docs/design/17-historical-sensitivity-checklist.md`](docs/design/17-historical-sensitivity-checklist.md)，2026-08-30 落地） | `GDD.md` §2.4 |
