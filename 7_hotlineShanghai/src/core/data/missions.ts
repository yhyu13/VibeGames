...
export const MISSIONS: Mission[] = [{
  ...
  id: 'm2_teahouse',
  nameZh: '春申茶馆',
  // 简报只说服你出口在哪,不说要清场:出口判据是账台那盏灯灭(Simulation.exitOpen()),与场上还剩几个守卫
  // 无关。这里原先写着「清场后从…前门撤离」——a0c6979 删掉清场要求时,门方块和 HUD 都改了,漏下的最后一句
  // 就在这里,而它是玩家在任务开场读到的唯一一段话:照着它做就是去刷一个设计锚点(撤离而非清场)排除的循环。
  brief: '春申茶馆是线人的情报交换点,占领军稽查队已进驻。经后门潜入:拆掉账台明灯,阁楼哨位失明,从霓虹招牌下的前门撤离。灯亮时别过堂心。',
  ratingS: 90,
  ratingA: 75,
  ratingB: 60,
  finalBossId: '',
