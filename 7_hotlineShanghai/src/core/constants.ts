...
export const LMB_LIGHT_PRIORITY_RANGE = 2.4;    // intro accessibility: visible knife reach + small input tolerance
...
export const RC_LIGHT_SCALE = 2.0;        // final.frag uLightScale(加法合成光增益,0..4;B28 定档 1.35;v3.11 环境光地板化后光池需更强的冲击补回房间对比度)
export const RC_AMBIENT_INTENSITY = 0.03;  // rc.frag uAmbientIntensity(v3.11 亮度地板语义:暗部 = base 压暗 + 0.03*lightScale;地板必须低于种子裙尾部亮度,否则光池周围再现暗环,同时不能冲掉暗区对比度)
