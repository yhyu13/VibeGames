...
export class SceneManager {
  ...
  private drawFlashlightCone(c: CanvasRenderingContext2D, p: Vec2, angle: number, z: number): void { c.save(); c.translate(p.x*z,p.y*z); c.rotate(angle); c.fillStyle='rgba(242,216,146,.055)'; c.beginPath(); c.moveTo(z*.2,0); c.arc(0,0,z*4,-18*Math.PI/180,18*Math.PI/180); c.closePath(); c.fill(); c.strokeStyle='rgba(248,221,157,.11)'; c.lineWidth=1; c.beginPath(); c.arc(0,0,z*4,-18*Math.PI/180,18*Math.PI/180); c.stroke(); c.restore(); }
}
