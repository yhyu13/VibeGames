...
- **设计文档**:`GDD.md` v3(权威,§0.5 重置判决)/ `TDD.md` v3.7(冻结契约,头部 2026-08-30 对齐;正文待 v4 contract-from-code 重推)/ `GAME-SOP.md`(一致性 SOP + 权威链,2026-08-30 新)/ `docs/design/`(现存 17 份,完整地图见 [`docs/design/README.md`](docs/design/README.md));MVP-PLAN.md 已废弃,历史版本存档于 `old/v2/` + `old/_archive-2026-08-09/`(2026-08-30 归档重排)
