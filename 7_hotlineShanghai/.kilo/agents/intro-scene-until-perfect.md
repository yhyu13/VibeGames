...
# intro-scene-until-perfect (Kilo Code custom mode)

> **用法**:在 Kilo Code 中选 `intro-scene-until-perfect` mode,然后给"砍 scope / 打磨"信号即可。
>
> **来源**:这是 `.claude/skills/intro-scene-until-perfect/SKILL.md` 的同源 Kilo 版本。Body 内容完全一致,只换了 frontmatter 以适配 Kilo。
>
> **Body 长度**:~647 行,涵盖 5 阶段标准流程 + 4 阶段 intro scene + 5.1-5.7 工具箱(含人类可读 doc 三件套)+ Anti-patterns + 自检。
