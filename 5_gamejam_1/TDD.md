...
设计文档仅存在 `docs/design/01-concept-core-loop.md`（02–05 未产出）。01 是设计层权威，GDD 被 01 数值细化处**以 01 为准**（01 §3.3 已声明 GDD 五项焦虑数值全部验证保留）。以下为技术层裁决：
...
*TDD v1.0 · 冻结契约 · 2026-08-06 · 配套：《Boss 的焦虑》GDD v0.1 + docs/design/01-concept-core-loop.md v0.1*
