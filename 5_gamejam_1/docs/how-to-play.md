...
![走位节拍——地板上的金色光圈就是目标](playguide/perform-move.png)
...
![台词节拍——圆环显示节拍类型和倒计时](playguide/perform-line.png)
...
**Q：隐藏结局？**
A：日记里连续写 3 次"我不够好"触发前置（开发开关 `STRETCH_FLAGS.hiddenEnding`，默认关闭，彩蛋位）。

---

*玩法文档 v1.1 · 截图来自 0.1.0 构建 · 更多设计细节见 `docs/design/` 与 `TDD.md`*
