...
> **Approved active direction (2026-08-09):** dense surface-voxel PBR on a
> warm natural 2.5D battlefield. This supersedes the neon awakening direction
> below. Characters use visible cube shells only (no ordinary sphere geometry
> for body, eye, pupil, horn, or cloud). The near-profile 31-degree perspective
> camera preserves silhouettes while shallow Z layers, contact shadows, warm
> key, cool rim, and fog prove real depth. Impact is local and material:
> missing body voxels, dark interior, tumbling fragments, and warm point light;
> fullscreen white impact flashes are forbidden.
