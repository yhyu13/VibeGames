...
> **Active approved build (2026-08-09): intro-only voxel physics showcase.**
> The active graph is `main.tsx -> IntroEngine`; obsolete `IntroDirector`
> awakening runtime has been removed and legacy battle files are dormant.
