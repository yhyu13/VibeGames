# TDD — PHASEWALK (四相行者) (current contract v0.17)
...
| v0.17 | 2026-08-16 | 打磨轮 25：回归验证确认 7 项、落 3 处——①F1 石板行 pad1–3 从 z=1.5 北移至 z=1.9（round-24 的 (0.3,1.5) 虽径向 1.53 清出中央塔柱，但 0.72m glyph 南缘坐于 z=1.14 落在塔柱内（塔柱最北 z=1.4），~29% glyph 被不透明塔柱遮挡；z=1.9 使 glyph 南缘 z=1.54 完全清出）；②HUD/levels 注释更正 pad 距池实测（pad1 4.55/pad2 2.85/pad3 1.75/pad4 1.66）与「pad3→pad4 仍擦进固化半径（~1.15m，三元提示兜底）」；③`SceneManager` 相玻板 z 注释/兜底 1.5→1.9 |
